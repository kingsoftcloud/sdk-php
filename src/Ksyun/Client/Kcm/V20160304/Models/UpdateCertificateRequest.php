...
class UpdateCertificateRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("CertSignature",$param) and $param["CertSignature"] !== null) {
            if(is_bool($param["CertSignature"])){
                $this->RequestParams["CertSignature"] = $param["CertSignature"] ? "true" : "false";
            } else {
                $this->RequestParams["CertSignature"] = $param["CertSignature"];
            }
        }
