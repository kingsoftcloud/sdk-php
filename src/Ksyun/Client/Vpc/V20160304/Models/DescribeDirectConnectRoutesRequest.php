...
class DescribeDirectConnectRoutesRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("DirectConnectRouteId",$param) and $param["DirectConnectRouteId"] !== null) {
            $res = $this->formatFilterParams("DirectConnectRouteId",$param["DirectConnectRouteId"]);
            $this->_unserialize("DirectConnectRouteId",$res);
        }
