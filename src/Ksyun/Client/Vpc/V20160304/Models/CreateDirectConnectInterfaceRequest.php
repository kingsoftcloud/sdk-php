...
class CreateDirectConnectInterfaceRequest extends BaseModel
{
    public $RequestParams = [
        ...
        "EnableIpv6" => null,
         /**String**/
        "CustomerIpv6PeerIp" => null,
         /**String**/
        "LocalIpv6PeerIp" => null,
    ];
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("CustomerIpv6PeerIp",$param) and $param["CustomerIpv6PeerIp"] !== null) {
            if(is_bool($param["CustomerIpv6PeerIp"])){
                $this->RequestParams["CustomerIpv6PeerIp"] = $param["CustomerIpv6PeerIp"] ? "true" : "false";
            } else {
                $this->RequestParams["CustomerIpv6PeerIp"] = $param["CustomerIpv6PeerIp"];
            }
        }
        if (array_key_exists("LocalIpv6PeerIp",$param) and $param["LocalIpv6PeerIp"] !== null) {
            if(is_bool($param["LocalIpv6PeerIp"])){
                $this->RequestParams["LocalIpv6PeerIp"] = $param["LocalIpv6PeerIp"] ? "true" : "false";
            } else {
                $this->RequestParams["LocalIpv6PeerIp"] = $param["LocalIpv6PeerIp"];
            }
        }
