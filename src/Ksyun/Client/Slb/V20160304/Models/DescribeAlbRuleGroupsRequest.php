...
class DescribeAlbRuleGroupsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("AlbRuleGroupId",$param) and $param["AlbRuleGroupId"] !== null) {
            $res = $this->formatFilterParams("AlbRuleGroupId",$param["AlbRuleGroupId"]);
            $this->_unserialize("AlbRuleGroupId",$res);
        }
