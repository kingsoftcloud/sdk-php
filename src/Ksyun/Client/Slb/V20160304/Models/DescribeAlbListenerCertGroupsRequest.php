...
class DescribeAlbListenerCertGroupsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("AlbListenerCertGroupId", $param) and $param["AlbListenerCertGroupId"] !== null) {
            $res = $this->formatFilterParams("AlbListenerCertGroupId", $param["AlbListenerCertGroupId"]);
            $this->_unserialize("AlbListenerCertGroupId", $res);
        }
