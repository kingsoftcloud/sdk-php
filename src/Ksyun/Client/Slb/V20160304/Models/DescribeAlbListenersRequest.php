...
class DescribeAlbListenersRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("AlbListenerId", $param) and $param["AlbListenerId"] !== null) {
            $res = $this->formatFilterParams("AlbListenerId", $param["AlbListenerId"]);
            $this->_unserialize("AlbListenerId", $res);
        }
