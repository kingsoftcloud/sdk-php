...
class DescribeListenerCertGroupsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("ListenerCertGroupId",$param) and $param["ListenerCertGroupId"] !== null) {
            $res = $this->formatFilterParams("ListenerCertGroupId",$param["ListenerCertGroupId"]);
            $this->_unserialize("ListenerCertGroupId",$res);
        }
