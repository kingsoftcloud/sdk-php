...
class CreateUserRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("AddProjectId",$param) and $param["AddProjectId"] !== null) {
            if(is_bool($param["AddProjectId"])){
                $this->RequestParams["AddProjectId"] = $param["AddProjectId"] ? "true" : "false";
            } else {
                $this->RequestParams["AddProjectId"] = $param["AddProjectId"];
            }
        }
