...
class FlushCacheClusterRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("DatabaseNo",$param) and $param["DatabaseNo"] !== null) {
            if(is_bool($param["DatabaseNo"])){
                $this->RequestParams["DatabaseNo"] = $param["DatabaseNo"] ? "true" : "false";
            } else {
                $this->RequestParams["DatabaseNo"] = $param["DatabaseNo"];
            }
        }
