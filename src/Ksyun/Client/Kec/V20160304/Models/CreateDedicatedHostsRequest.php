...
class CreateDedicatedHostsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("EbsClusterMode",$param) and $param["EbsClusterMode"] !== null) {
            if(is_bool($param["EbsClusterMode"])){
                $this->RequestParams["EbsClusterMode"] = $param["EbsClusterMode"] ? "true" : "false";
            } else {
                $this->RequestParams["EbsClusterMode"] = $param["EbsClusterMode"];
            }
        }
