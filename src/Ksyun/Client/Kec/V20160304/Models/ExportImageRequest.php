...
class ExportImageRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("ImageExportType",$param) and $param["ImageExportType"] !== null) {
            if(is_bool($param["ImageExportType"])){
                $this->RequestParams["ImageExportType"] = $param["ImageExportType"] ? "true" : "false";
            } else {
                $this->RequestParams["ImageExportType"] = $param["ImageExportType"];
            }
        }
