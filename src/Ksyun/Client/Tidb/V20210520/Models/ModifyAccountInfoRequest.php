...
class ModifyAccountInfoRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("AccountType",$param) and $param["AccountType"] !== null) {
            if(is_bool($param["AccountType"])){
                $this->RequestParams["AccountType"] = $param["AccountType"] ? "true" : "false";
            } else {
                $this->RequestParams["AccountType"] = $param["AccountType"];
            }
        }
