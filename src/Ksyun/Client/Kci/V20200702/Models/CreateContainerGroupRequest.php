...
class CreateContainerGroupRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("MultiEipAllocationId",$param) and $param["MultiEipAllocationId"] !== null) {
            $res = $this->formatFilterParams("MultiEipAllocationId",$param["MultiEipAllocationId"]);
            $this->_unserialize("MultiEipAllocationId",$res);
        }
