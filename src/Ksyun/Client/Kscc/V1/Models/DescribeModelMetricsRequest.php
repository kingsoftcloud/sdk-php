...
class DescribeModelMetricsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("TimeInterval",$param) and $param["TimeInterval"] !== null) {
            if(is_bool($param["TimeInterval"])){
                $this->RequestParams["TimeInterval"] = $param["TimeInterval"] ? "true" : "false";
            } else {
                $this->RequestParams["TimeInterval"] = $param["TimeInterval"];
            }
        }
