...
class GetRealTimeHitRateDataRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("HitRatetype", $param) and $param["HitRatetype"] !== null) {
            if (is_bool($param["HitRatetype"])) {
                $this->RequestParams["HitRatetype"] = $param["HitRatetype"] ? "true" : "false";
            } else {
                $this->RequestParams["HitRatetype"] = $param["HitRatetype"];
            }
        }
