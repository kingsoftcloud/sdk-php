...
class CreateRetentionPolicyRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("DefaultPolicy",$param) and $param["DefaultPolicy"] !== null) {
            if(is_bool($param["DefaultPolicy"])){
                $this->RequestParams["DefaultPolicy"] = $param["DefaultPolicy"] ? "true" : "false";
            } else {
                $this->RequestParams["DefaultPolicy"] = $param["DefaultPolicy"];
            }
        }
