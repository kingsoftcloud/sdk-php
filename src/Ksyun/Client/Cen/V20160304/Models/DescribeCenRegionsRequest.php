...
class DescribeCenRegionsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("CenRegionId", $param) and $param["CenRegionId"] !== null) {
            $res = $this->formatFilterParams("CenRegionId", $param["CenRegionId"]);
            $this->_unserialize("CenRegionId", $res);
        }
