...
class DescribeNetworkInstancesRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("NetworkInstanceId",$param) and $param["NetworkInstanceId"] !== null) {
            $res = $this->formatFilterParams("NetworkInstanceId",$param["NetworkInstanceId"]);
            $this->_unserialize("NetworkInstanceId",$res);
        }
