...
class DescribeCenRegionBandwidthsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("CenRegionBandwidthId", $param) and $param["CenRegionBandwidthId"] !== null) {
            $res = $this->formatFilterParams("CenRegionBandwidthId", $param["CenRegionBandwidthId"]);
            $this->_unserialize("CenRegionBandwidthId", $res);
        }
