...
class DescribeInterAreasRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("InterAreaId",$param) and $param["InterAreaId"] !== null) {
            $res = $this->formatFilterParams("InterAreaId",$param["InterAreaId"]);
            $this->_unserialize("InterAreaId",$res);
        }
