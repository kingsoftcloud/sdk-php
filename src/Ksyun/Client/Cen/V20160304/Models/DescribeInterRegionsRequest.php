...
class DescribeInterRegionsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("InterRegionId",$param) and $param["InterRegionId"] !== null) {
            $res = $this->formatFilterParams("InterRegionId",$param["InterRegionId"]);
            $this->_unserialize("InterRegionId",$res);
        }
