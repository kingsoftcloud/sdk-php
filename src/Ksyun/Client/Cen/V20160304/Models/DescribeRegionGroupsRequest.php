...
class DescribeRegionGroupsRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("RegionGroupId", $param) and $param["RegionGroupId"] !== null) {
            $res = $this->formatFilterParams("RegionGroupId", $param["RegionGroupId"]);
            $this->_unserialize("RegionGroupId", $res);
        }
