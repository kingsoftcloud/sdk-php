...
class DescribeCenRoutesRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("CenRouteId", $param) and $param["CenRouteId"] !== null) {
            $res = $this->formatFilterParams("CenRouteId", $param["CenRouteId"]);
            $this->_unserialize("CenRouteId", $res);
        }
