...
class AddTrialToBuyTaskRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("autoTrialToBuyDate",$param) and $param["autoTrialToBuyDate"] !== null) {
            if(is_bool($param["autoTrialToBuyDate"])){
                $this->RequestParams["autoTrialToBuyDate"] = $param["autoTrialToBuyDate"] ? "true" : "false";
            } else {
                $this->RequestParams["autoTrialToBuyDate"] = $param["autoTrialToBuyDate"];
            }
        }
