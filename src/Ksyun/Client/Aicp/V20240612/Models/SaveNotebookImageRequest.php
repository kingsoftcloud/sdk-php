...
class SaveNotebookImageRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("ImageDomain",$param) and $param["ImageDomain"] !== null) {
            if(is_bool($param["ImageDomain"])){
                $this->RequestParams["ImageDomain"] = $param["ImageDomain"] ? "true" : "false";
            } else {
                $this->RequestParams["ImageDomain"] = $param["ImageDomain"];
            }
        }
