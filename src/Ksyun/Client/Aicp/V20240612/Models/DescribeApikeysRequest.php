...
class DescribeApikeysRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("SelfCreated",$param) and $param["SelfCreated"] !== null) {
            if(is_bool($param["SelfCreated"])){
                $this->RequestParams["SelfCreated"] = $param["SelfCreated"] ? "true" : "false";
            } else {
                $this->RequestParams["SelfCreated"] = $param["SelfCreated"];
            }
        }
