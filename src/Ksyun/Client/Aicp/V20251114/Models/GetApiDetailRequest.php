...
class GetApiDetailRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("ApiName",$param) and $param["ApiName"] !== null) {
            if(is_bool($param["ApiName"])){
                $this->RequestParams["ApiName"] = $param["ApiName"] ? "true" : "false";
            } else {
                $this->RequestParams["ApiName"] = $param["ApiName"];
            }
        }
