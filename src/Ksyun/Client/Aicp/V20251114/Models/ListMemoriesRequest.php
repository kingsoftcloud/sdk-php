...
class ListMemoriesRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("TopicId",$param) and $param["TopicId"] !== null) {
            if(is_bool($param["TopicId"])){
                $this->RequestParams["TopicId"] = $param["TopicId"] ? "true" : "false";
            } else {
                $this->RequestParams["TopicId"] = $param["TopicId"];
            }
        }
