...
class DescribeDTSParameterRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("SourceHost",$param) and $param["SourceHost"] !== null) {
            if(is_bool($param["SourceHost"])){
                $this->RequestParams["SourceHost"] = $param["SourceHost"] ? "true" : "false";
            } else {
                $this->RequestParams["SourceHost"] = $param["SourceHost"];
            }
        }
