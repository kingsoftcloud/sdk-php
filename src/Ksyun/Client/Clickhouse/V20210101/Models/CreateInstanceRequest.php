...
class CreateInstanceRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("ProductWhat",$param) and $param["ProductWhat"] !== null) {
            if(is_bool($param["ProductWhat"])){
                $this->RequestParams["ProductWhat"] = $param["ProductWhat"] ? "true" : "false";
            } else {
                $this->RequestParams["ProductWhat"] = $param["ProductWhat"];
            }
        }
