...
class CreateDBInstanceRequest extends BaseModel
{
    public $RequestParams = [
        ...
        "ProjectId" => null,
         /**Int**/
        "TableNamesAreCaseSensitive" => null,
    ];
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("TableNamesAreCaseSensitive",$param) and $param["TableNamesAreCaseSensitive"] !== null) {
            if(is_bool($param["TableNamesAreCaseSensitive"])){
                $this->RequestParams["TableNamesAreCaseSensitive"] = $param["TableNamesAreCaseSensitive"] ? "true" : "false";
            } else {
                $this->RequestParams["TableNamesAreCaseSensitive"] = $param["TableNamesAreCaseSensitive"];
            }
        }
