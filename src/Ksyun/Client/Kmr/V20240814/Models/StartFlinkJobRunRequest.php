...
class StartFlinkJobRunRequest extends BaseModel
{
    ...
    public function setParams($param = [])
    {
        ...
        if (array_key_exists("SubmitData",$param) and $param["SubmitData"] !== null) {
            if(is_bool($param["SubmitData"])){
                $this->RequestParams["SubmitData"] = $param["SubmitData"] ? "true" : "false";
            } else {
                $this->RequestParams["SubmitData"] = $param["SubmitData"];
            }
        }
